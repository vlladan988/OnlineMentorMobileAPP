...
const SubmitButtonCreateGrocery = ({ submitForm }) => {
  return (
    <View style={ShadowStyleHigh}>
      ...
      >
        <TouchableOpacity style={styles.submitButton} onPress={submitForm}>
          <Text style={styles.submitButtonText}>Create Grocery</Text>
        </TouchableOpacity>
      </LinearGradient>
    </View>
  );
...
export default SubmitButtonCreateGrocery;

SubmitButtonCreateGrocery.propTypes = {
