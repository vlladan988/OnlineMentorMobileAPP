...
const SharedRecipeDailyModal = ({ isVisible, closeModal, recipe }) => {
          ...
          <ScrollView style={styles.scroll}>
            ...
            <View style={styles.detailsWrapper}>
              <View style={styles.nameWrapper}>
                <Text style={styles.nameText}>{recipe && recipe.name}</Text>
              </View>
              ...
              <View style={styles.groceryWrapper}>
                ...
                <View style={styles.groceryDetailWrapper}>
                  {recipe &&
                    recipe.daily_recipe_groceries &&
                    recipe.daily_recipe_groceries.map((grocery, index) => (
                ...
                <View style={styles.descriptionBlur}>
                  <ScrollView>
                    <Text style={styles.descriptionText}>
                      {recipe && recipe.recipe_description}
                    </Text>
                  </ScrollView>
                </View>
              </ImageBackground>
...
export default SharedRecipeDailyModal;

SharedRecipeDailyModal.propTypes = {
